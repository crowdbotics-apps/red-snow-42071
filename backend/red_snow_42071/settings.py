"""
Django settings for red_snow_42071 project.
...
ROOT_URLCONF = 'red_snow_42071.urls'
...
WSGI_APPLICATION = 'red_snow_42071.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_snow_42071 API",
    "DESCRIPTION": "API documentation for red_snow_42071 App",
    "VERSION": "v1",
}
